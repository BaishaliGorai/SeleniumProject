...
public class AssetFilterModTC12 {
	...
	public static void main(String[] args) {
		...
		Select dateFilter = new Select(driver.findElement(By.id("stdDateFilter")));
		dateFilter.selectByValue("prevfy");
		
		String startDate = driver.findElement(By.name("startdate")).getText();
		String endDate = driver.findElement(By.name("enddate")).getText();
