...
public class AssetFilterModTC4 {
	...
	public static void main(String[] args) {
		...
		String missingViewNameErr = alt.getText();
		
		if(missingViewNameErr.contains("View Name"))
		{
			System.out.println("Missing required field: view name alert popup displayed.");
		}
		else
		{
			System.out.println("Missing required field: view name alert popup not displayed.");
		}
