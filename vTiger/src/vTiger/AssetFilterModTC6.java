...
public class AssetFilterModTC6 {
	...
	public static void main(String[] args) {
		...
		Alert alt = tl.alert();
		String reqdErrorMsg = alt.getText();
		
		if(reqdErrorMsg.contains("Must have one Required field to be selected"))
		{
			System.out.println("Must have one required field error message should display.");
		}
		else
		{
			System.out.println("Must have one required field error message not displayed.");
		}
