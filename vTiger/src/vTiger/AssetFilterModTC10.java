...
public class AssetFilterModTC10 {
	...
	public static void main(String[] args) {
		...
		{
			System.out.println("Filter created with public is present in the list.");
		}
		else
		{
			System.out.println("Filter created with public is not present in the list.");
		}
